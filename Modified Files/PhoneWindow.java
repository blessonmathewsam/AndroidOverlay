...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    /* ViewGroup of overlay avtivity to be set as the parent*/
    static ViewGroup mOverlayParent;
    static int mOverlayParentId;
    boolean openInOverlayWindow = false;
    ...
    public void setContentView(int layoutResID) {
        ...
        if (mContentParent == null) {
          ...
          Log.v("PhoneWindowLog", "Userlog - setContentView !hasFeature(FEATURE_CONTENT_TRANSITIONS)");
...
/*
  ...
  Set mOverlayParent to the ViewGroup of the OverlayActivity */
    ...
    public void setOverlayParent(int layoutResID) {
      Log.v("PhoneWindowLog", "Userlog - setOverlayParent called with id : "+layoutResID);
    ...
    /* User defined function
      Set mOverlayParent back to null*/
    @Override
    ...
    /* User defined function
      Get value of openInOverlayWindow*/
    public boolean getOpenInOverlayWindow(){
         return openInOverlayWindow;
    }

    /* User defined function
      Set value of openInOverlayWindow */
    public void setOpenInOverlayWindow(boolean val){
      openInOverlayWindow = val;
      Log.v("PhoneWindowLog", "Userlog - openInOverlayWindow set to : "+openInOverlayWindow);
    }
    ...
    */
    ...
    public Bundle saveHierarchyState() {
        ...
        if(openInOverlayWindow || getContext().getApplicationContext().getGlobalOpenInOverlayWindow()){
          Log.v("PhoneWindowLog", "Userlog - Adding parameter in saveHierarchyState()");
          outState.putChar("openInOverlayWindow",'1');
        }
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        */
        ...
        if(getContext().getApplicationContext().getGlobalOpenInOverlayWindow()){
          params.width = 250;
          params.height = 340;
...
/*
        if(!(openInOverlayWindow || getContext().getApplicationContext().getGlobalOpenInOverlayWindow())){
            ...
            if(contentParent instanceof FrameLayout){
              Log.v("PhoneWindowLog", "contentParent is an instanceof FrameLayout ");
              FrameLayout.LayoutParams frameParams = new FrameLayout.LayoutParams(240,320,Gravity.CENTER);
              //frameParams.gravity = Gravity.CENTER;
              contentFrame.setLayoutParams(frameParams);
            }
            else if(contentParent instanceof LinearLayout){
              Log.v("PhoneWindowLog", "contentParent is an instanceof LinearLayout");
              LinearLayout.LayoutParams frameParams = new LinearLayout.LayoutParams(240,320);
              frameParams.gravity = Gravity.CENTER;
              contentFrame.setLayoutParams(frameParams);
            }
            else{
...
*/
        ...
        if (mContentParent == null) {
            Log.v("PhoneWindowLog", "Userlog - mContentParent == null");
