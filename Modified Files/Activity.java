...
public class Activity extends ContextThemeWrapper
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
        	if(this.getApplicationContext().getGlobalOpenInOverlayWindow()==false){
        		if(savedInstanceState.getChar("openInOverlayWindow")!='1'){
        			  Log.v("ActivityLog", "Userlog - Not to be opened in OverlayActivity");
        		...
        		if(savedInstanceState.getChar("openInOverlayWindow")=='1'){
        			  Log.v("ActivityLog", "Userlog - To be opened in OverlayActivity");
        			  Parcelable p = savedInstanceState.getParcelable(FRAGMENTS_TAG);
            		  mFragments.restoreAllState(p, mLastNonConfigurationInstances != null
                    ? mLastNonConfigurationInstances.fragments : null);
        		}
    ...
    final void performRestoreInstanceState(Bundle savedInstanceState) {
    	Log.v("ActivityLog", "Userlog - performRestoreInstanceState() called without persistent state");
    	if(this.getApplicationContext().getGlobalOpenInOverlayWindow()==false && savedInstanceState.getChar("openInOverlayWindow")=='1'){
    		 Log.v("ActivityLog", "Userlog - Skipping performRestoreInstanceState()");
    		 return;
    	}
    ...
    final void performRestoreInstanceState(Bundle savedInstanceState,
    	...
    	Log.v("ActivityLog", "Userlog - performRestoreInstanceState() called with persistent state");
    	if(this.getApplicationContext().getGlobalOpenInOverlayWindow()==false && savedInstanceState.getChar("openInOverlayWindow")=='1'){
    		 Log.v("ActivityLog", "Userlog - Skipping performRestoreInstanceState()");
    		 return;
    	}
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.v("ActivityLog", "Userlog - onRestoreInstanceState() called");
        if (mWindow != null) {
        	if(this.getApplicationContext().getGlobalOpenInOverlayWindow()==false && savedInstanceState.getChar("openInOverlayWindow")=='1'){
    		 Log.v("ActivityLog", "Userlog - Skipping performRestoreInstanceState()");
    		 return;
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState,
            PersistableBundle persistentState) {
    	Log.v("ActivityLog", "Userlog - Skipping onRestoreInstanceState()");
        if (savedInstanceState != null) {
        	if(this.getApplicationContext().getGlobalOpenInOverlayWindow()==false && savedInstanceState.getChar("openInOverlayWindow")=='1'){
    		 Log.v("ActivityLog", "Userlog - Skipping performRestoreInstanceState()");
    		 return;
    ...
    public void setContentView(@LayoutRes int layoutResID) {
        Log.v("ActivityLog", "Userlog - setContentView called within activity. Theme : "+mActivityInfo.theme);
    ...
    public void setOverlayParent(int layoutResID) {
       getWindow().setOverlayParent(layoutResID);
    }

    /* User defined function
      Reset mOverlayParent back to null*/

    public void removeOverlayParent(int layoutResID) {
      getWindow().setOverlayParent(layoutResID);
    }
    ...
    public void checkTypedArray(int resid){
      int[] attrs = {android.R.attr.windowIsTranslucent, android.R.attr.windowIsFloating, android.R.attr.colorPrimary, android.R.attr.background, android.R.attr.colorBackgroundCacheHint
};
      int[] attrs2 = {android.R.attr.windowIsTranslucent};

      TypedArray ta = obtainStyledAttributes(attrs);
      TypedArray ta2 = obtainStyledAttributes(com.android.internal.R.style.Theme_Translucent, attrs2);
      TypedArray ta3 = obtainStyledAttributes(attrs2);


      int colorPrimary = ta.getColor(2,Color.GREEN);
      ...
      Log.v("ActivityLog","Userlog - Retrieved typed array ta2 : "+ta2.toString());
      Log.v("ActivityLog","Userlog - Retrieved typed array ta3 : "+ta3.toString());

      Log.v("ActivityLog","Userlog - Retrieved colorPrimary : "+ colorPrimary);
    ...
    protected void onApplyThemeResource(Resources.Theme theme, @StyleRes int resid,
            boolean first) {
        Log.v("ActivityLog", "Userlog - onApplyThemeResource called with theme : "+theme+", first :"+first);
        ...
        if(this.getApplicationContext().getGlobalOpenInOverlayWindow()){
          ...
          theme.applyStyle(com.android.internal.R.style.Theme_Translucent, true);
          checkTypedArray(resid);
        }
        */
    ...
    final void attach(Context context, ActivityThread aThread,
        ...
        Log.v("ActivityLog", "Userlog - info.theme : "+info.theme);
        ...
        User defined code
        */
        if(intent.getIntExtra("parentId",-1)!=-1 || context.getApplicationContext().getGlobalOpenInOverlayWindow()){
          ...
          this.convertToTranslucent(null,null);
        }
        else{
        	mWindow.setOpenInOverlayWindow(false);
          	context.getApplicationContext().setGlobalOpenInOverlayWindow(false);
        }
